...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $widget['total_loss_amount'] = GameLog::where('user_id', $user->id)->where('win_status', 0)->sum('invest');
        $widget['total_earned'] = getAmount($widget['total_win_amount'] - $widget['total_loss_amount']);

        return view('admin.users.detail', compact('pageTitle', 'user','totalDeposit','totalWithdraw','totalTransaction','countries', 'widget'));
    }
    ...
    public function emailLog($id){
        ...
        return view('admin.users.email_log', compact('pageTitle','logs','emptyMessage'));
    }
