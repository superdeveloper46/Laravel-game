												...
												<div class="row">
													<div class="col-md-12">
					        							<div class="form-group">
					        								...
					        								<div class="input-group mb-3">
					        									<input type="number" class="form-control" name="probable" value="{{ getAmount($game->probable_win) }}" placeholder="@lang('Winning Chance')">
					        									<div class="input-group-append">
													...
													<div class="col-md-6">
					        							<div class="form-group">
					        								...
					        								<div class="input-group mb-3">
					        									<input type="text" class="form-control" placeholder="@lang('Win')" value="{{ getAmount($game->win) }}" name="win">
					        									<div class="input-group-append">
					        										<span class="input-group-text" id="basic-addon2">@lang('%')</span>
					        									</div>
					        								</div>
													...
													<div class="col-md-6">
														<div class="form-group">
					        								...
					        								<div class="input-group mb-3">
					        									<input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Give Back')" data-off="@lang('No Back')" name="invest_back" @if($game->invest_back == 1) checked @endif>
					        								</div>
					        							</div>
													</div>
												</div>
...
<a href="{{ route('admin.game.index') }}" class="icon-btn"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
