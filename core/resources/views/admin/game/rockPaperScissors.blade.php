		        					...
		        					<div class="image-upload">
		        						<div class="thumb">
		        							<div class="avatar-preview">
		        								<div class="profilePicPreview" style="background-image: url({{ getImage(imagePath()['game']['path'].'/'.$game->image,imagePath()['game']['path']) }})">
	        							...
	        							<div class="card border--primary">
	        								...
	        								<div class="card-body">
			        							...
			        							<div class="form-group">
			        								...
			        								<div class="input-group mb-3">
			        									<input type="text" name="max" min="1" class="form-control" placeholder="Maximum Invest Amount" value="{{ getAmount($game->max_limit) }}" required>
			        									<div class="input-group-append">
			        										<span class="input-group-text" id="basic-addon2">{{ $general->cur_sym }}</span>
			        									</div>
			        								</div>
												...
												<div class="row">
													...
													<div class="col-md-6">
					        							<div class="form-group">
					        								...
					        								<div class="input-group mb-3">
					        									<input type="text" class="form-control" placeholder="@lang('Win Amount')" value="{{ getAmount($game->win) }}" name="win">
					        									<div class="input-group-append">
					        										<span class="input-group-text" id="basic-addon2">@lang('%')</span>
					        									</div>
					        								</div>
